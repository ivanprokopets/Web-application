...
class PaginatedBookResponse:
    ...
    def get_json(self, url):
        ...
        post_l = "http://localhost:7001/book/list"
        body = "Informatika"

        links = "http://localhost:7001/book/1"
        link = "http://localhost:7001/book/1"
        return {
            "books": self.books,
            "start": self.start,
            "limit": self.limit,
            ...
            "next": next_url,
            "links": {"POST":post_l,"body":{"title":body,
                                         "year":"2020",
                                         "author_id":"1"},
                      "GET":links,
                      "DELETE":link},
            "FILE_link": "http://localhost:7001/file/1"
        }
